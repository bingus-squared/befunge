...
final characters = [
  ...
  '\u{1F6A9}', // 0x80 (Triangular Flag On Post)
  '\u{1F6A9}', // 0x81 (Triangular Flag On Post)
  '\u{1F6A9}', // 0x82 (Triangular Flag On Post)
  '\u{1F6A9}', // 0x83 (Triangular Flag On Post)
  '\u{1F6A9}', // 0x84 (Triangular Flag On Post)
  '\u{1F6A9}', // 0x85 (Triangular Flag On Post)
  '\u{1F6A9}', // 0x86 (Triangular Flag On Post)
  '\u{1F6A9}', // 0x87 (Triangular Flag On Post)
  '\u{1F6A9}', // 0x88 (Triangular Flag On Post)
  '\u{1F6A9}', // 0x89 (Triangular Flag On Post)
